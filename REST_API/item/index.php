...
<?php 
	...
	$data='{"Id":"'.$res['Id'].'", "Name":"'.$res['Title'].'", "Category":"'.$res['Category'].'", "Gender":"'.$res['Gender'].'", "Price":"'.$res['Price'].'", "Description":"'.$res['Description'].'", "Country":"'.$res['Country'].'", "imageUrl":"'.$res['Image_url'].'", "Quantities":['.$quantities.']}';
